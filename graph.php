<?php
	...
	$sql_query= "SELECT rating FROM Rating where movie = '$movie' and rating = 5 ";
	$query_run = mysql_query($sql_query);
	$rate5  = mysql_num_rows($query_run);

	$sql_query= "SELECT rating FROM Rating where movie = '$movie' and rating = 4 ";
	$query_run = mysql_query($sql_query);
	$rate4  = mysql_num_rows($query_run);

	$sql_query= "SELECT rating FROM Rating where movie = '$movie' and rating = 3 ";
	$query_run = mysql_query($sql_query);
	$rate3  = mysql_num_rows($query_run);

	$sql_query= "SELECT rating FROM Rating where movie = '$movie' and rating = 2 ";
	$query_run = mysql_query($sql_query);
	$rate2  = mysql_num_rows($query_run);

	$sql_query= "SELECT rating FROM Rating where movie = '$movie' and rating = 1 ";
	$query_run = mysql_query($sql_query);
