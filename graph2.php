<?php
	...
	$sql_query= "SELECT Visit_Time FROM visit_counter where Visit_Time = '$dt' and Movie_Name='$movie' ";
	...
	$sql_query= "SELECT Visit_Time FROM visit_counter where Visit_Time like '$month%' and Movie_Name='$movie' ";
	$query_run = mysql_query($sql_query);
	$month  = mysql_num_rows($query_run);

	$year = substr($dt, 0,4);

	$sql_query= "SELECT Visit_Time FROM visit_counter where Visit_Time like '$year%' and Movie_Name='$movie' ";
	$query_run = mysql_query($sql_query);
